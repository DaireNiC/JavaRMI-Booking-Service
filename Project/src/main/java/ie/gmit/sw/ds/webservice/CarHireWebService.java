package ie.gmit.sw.ds.webservice;
...
import ie.gmit.sw.ds.db.CarHireDB;
...
public class CarHireWebService {
	...
	@Consumes(MediaType.APPLICATION_XML)
	@Path("/update")
	public Response updateOrder(RentalOrder updated) {
		boolean success = false;
		...
		if(success) {
			String msg = "The order number " + " was updated!";
			return Response.status(200).entity(msg).build();
		}
		else {
			String msg = "The order number "  + " does not exist";;
