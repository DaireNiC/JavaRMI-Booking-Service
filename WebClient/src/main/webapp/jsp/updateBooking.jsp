	...
	<form:form modelAttribute="RentalOrder">
		<table>
			...
			<tr>
				...
				<td><form:select path="customer.customerSID" items="${custList}" /></td>
				<td><form:errors path="customer.customerSID" items="${custList}" /></td>
			</tr>
			<tr>
				<td>Update Their Car:</td>
				<td><form:select path="vehicle.vehicleSID" items="${carList}" /></td>
				<td><form:errors path="vehicle.vehicleSID" items="${carList}" /></td>
			</tr>
			<tr>
